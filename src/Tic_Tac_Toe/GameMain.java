    ...
    public GameMain() {
       ...
       player1 = scanner.nextLine();
        ...
        do {
            ...
            } while (!status.toUpperCase().equals("Y"));
            // Switch player
    ...
    public void playerMove(Seed theSeed) {
        ...
        do {
            if (theSeed == Seed.CROSS) {
                ...
                System.out.print(player1+ " the player of 'X' nut , enter your move (row[1-3] column[1-3]): ");
            } else {
                System.out.print(player2+ " the player of 'O' nut , enter your move (row[1-3] column[1-3]): ");
            }
